...
<body >
<form method="POST" action="CreateAccountBusinessReceipt.php">
<center>

        <h2>Adaptive Accounts - Create Account- Business</h2>
 ...
 <table class="api">      
  ...
  <tr>
    ...
    <tr>  
  <td> <p align="right"><font size = "3" >Business Info:</font></p> </td>  
    </tr>
 ...
 <td><input type="text" size="25" maxlength="40" name="biz_address_city"
	...
	<td class="field">State:</td>
	  <td><select name="biz_address_state">
        ...
        <tr>
	<td class="field">ZIP Code:</td>
        <td><input type="text" size="30" maxlength="10" name="biz_address_postalCode"
            value="78750" />(5 or 9 digits)</td>
</tr>
