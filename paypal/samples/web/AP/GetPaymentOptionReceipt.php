...
<table width=500 class="api">
	...
	<tr>
		...
		<td><?php echo $GPOResponse->displayOptions->emailHeaderImageUrl ; ?></td>

	</tr>
	<tr>
		<td>Email Marketing Image URL:</td>
		<td><?php echo $GPOResponse->displayOptions->emailMarketingImageUrl ; ?></td>
	</tr>
	<tr>
		<td>InstitutionId:</td>
		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->institutionId ; ?></td>

	</tr>
	<tr>
		<td>Institution CustomerId:</td>
		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->institutionCustomerId ; ?></td>
	</tr>
	<tr>
		<td>Email:</td>
		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->email ; ?></td>

	</tr>

	<tr>
		<td>Country Code:</td>
		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->countryCode ; ?></td>
	</tr>
	<tr>
		<td>Display Name:</td>
		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->displayName ; ?></td>

	</tr>
	<tr>
		<td>First Name:</td>
		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->firstName ; ?></td>
	</tr>
	<tr>
		<td>Last Name:</td>

		<td><?php echo $GPOResponse->initiatingEntitity->institutionCustomer->lastName ; ?></td>
	</tr>
</table>
